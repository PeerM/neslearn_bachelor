...
parser.add_option("-t", "--num_frames", dest="nframes", default=1, type='int',
...
parser.add_option("-E", "--render_rate", dest="render_rate", default=2.0, help="[%default]")
parser.add_option("-n", "--render_ngames", dest="render_ngames", default=2, help="[%default]")
parser.add_option("-C", "--checkpoint_interval", dest="checkpoint_interval", default=10000, help="[%default]")
...
agent.render_rate_hz = options.render_rate
agent.render_ngames = options.render_ngames
agent.checkpoint_interval = options.checkpoint_interval
agent.train()
