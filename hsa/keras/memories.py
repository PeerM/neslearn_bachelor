...
def load_memories(_memory, memory_filename="../mario_1_1_first.hdf"):
    inputs = pandas.read_hdf(memory_filename, key="inputs")
    rams = pandas.read_hdf(memory_filename, key="rams")
