...
model = zoo.make_2_hidden_wide_beginning_stable(nb_frames, ram_size, nr_actions)
...
try:
    ...
    pandas.DataFrame.from_dict(epoch_results).to_csv("../dqn_weights/keras/tmp/cartpole_{}.csv".format(model_name))
